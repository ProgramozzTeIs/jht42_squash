...
CREATE TABLE `match` (
  ...
  `scoreplayer1` int DEFAULT NULL,
  `scoreplayer2` int DEFAULT NULL,
...
INSERT INTO `match` VALUES (1,2,3,1,43,34,'2023-12-27 18:30:00'),(3,2,4,2,55,60,'2023-07-12 11:45:00');
